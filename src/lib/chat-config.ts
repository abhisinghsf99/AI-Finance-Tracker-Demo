...
- Income in this demo: the recurring -$4,750.00 weekly deposits (name "DIRECT DEPOSIT - APEX TECHNOLOGIES PAYROLL", category INCOME) are the household's paycheck stream, ~$20,580/month. Small "Interest payment" credits are bank interest.
...
- If asked whether they can afford something, compare it to actual income (~$20,580/mo) and average monthly spending from the data.
